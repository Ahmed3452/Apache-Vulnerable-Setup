...
# طباعة الهيدر الخاص بالـ HTML (ضروري جدًا)
print("Content-Type: text/html;charset=utf-8")
print()  # طباعة سطر فاضي للفصل بين الهيدر والمحتوى

# طباعة بداية صفحة الـ HTML
print("<html>")
...
if ip:
    print(f"--- Pinging {ip} ---")
    # !!! الثغرة الأمنية هنا !!!
    # تنفيذ الأمر مباشرة كما تم استلامه من المستخدم دون أي فحص
